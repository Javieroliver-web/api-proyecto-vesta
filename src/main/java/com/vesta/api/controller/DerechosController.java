...
public class DerechosController {
    ...
    public ResponseEntity<?> solicitarAcceso(@Valid @RequestBody SolicitudRequest request) {
    ...
    public ResponseEntity<?> solicitarRectificacion(@Valid @RequestBody SolicitudRequest request) {
        SolicitudDatos solicitud = new SolicitudDatos();
        solicitud.setUsuarioId(request.getUsuarioId());
    ...
    public ResponseEntity<?> solicitarSupresion(@Valid @RequestBody SolicitudRequest request) {
    ...
    public ResponseEntity<?> solicitarPortabilidad(@Valid @RequestBody SolicitudRequest request) {
        SolicitudDatos solicitud = new SolicitudDatos();
        solicitud.setUsuarioId(request.getUsuarioId());
